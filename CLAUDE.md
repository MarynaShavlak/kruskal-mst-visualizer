...
Двомовні (UA/EN): каталог/шапка, навчальна вкладка (markdown), редактор і плеєр
(хром через i18n/messages; нарація trace — через інжектований у білдери `Translate`).
Лишився бенчмарк (Recharts) — поки українською.
