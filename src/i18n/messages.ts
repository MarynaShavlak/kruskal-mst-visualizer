...
const ua = {
  ...
  "play.krLcTitle": "Жива складність",
  "play.krLcActual": "Фактично:",
  ...
  "play.fwLcTitle": "Жива складність",
  "play.fwLcActual": "Фактично:",
  ...
  "play.hkLcTitle": "Жива складність",
  "play.hkLcActual": "Фактично:",
  "play.hkLcUnit": "комірок dp",
  "play.hkLcPoly": "поліном (омріяний)",
  "play.hkLcStates": "стани Хелда–Карпа",
  "play.hkLcVerdict": "Хелда–Карпа: експоненційно — (n−1)·2^(n−1) станів DP (поліном був би ~n²). Найкращий ТОЧНИЙ для TSP (краще за перебір n! на великих n), та масштабувати годі.",
  ...
  "play.knapLcTitle": "Жива складність",
  "play.knapLcActual": "Фактично:",
  ...
  "play.primLcTitle": "Жива складність",
  "play.primLcActual": "Фактично:",
  ...
  "play.isLcTitle": "Жива складність",
  "play.isLcActual": "Фактично:",
  ...
  "play.ssLcTitle": "Жива складність",
  "play.ssLcActual": "Фактично:",
  ...
  "play.msLcTitle": "Жива складність",
  "play.msLcActual": "Фактично:",
  ...
  "play.shLcTitle": "Жива складність",
  "play.shLcActual": "Фактично:",
  ...
  "play.rxLcTitle": "Жива складність",
  "play.rxLcActual": "Фактично:",
  ...
  "play.lsLcTitle": "Жива складність",
  "play.lsLcActual": "Фактично:",
  ...
  "play.issLcTitle": "Жива складність",
  "play.issLcActual": "Фактично:",
  ...
  "play.ipLcTitle": "Жива складність",
  "play.ipLcActual": "Фактично:",
  "play.ipLcUnit": "проб",
  ...
  "play.nssLcTitle": "Жива складність",
  "play.nssLcActual": "Фактично:",
  ...
  "editor.kmpMain": "Канонічний приклад",
  "editor.kmpKonspect": "Конспект («алг»)",
  "editor.kmpWorst": "Найгірший (AAAA…)",
  "editor.kmpNotFoundPreset": "Не знайдено",
  "editor.kmpEditorTitle": "Текст і шаблон",
  ...
  "editor.helpKmpKonspect": "приклад із конспекту: «алг» → позиція 4, lps = [0, 0, 0]",
  ...
  "editor.kmpErrBadText": "Поле text має бути рядком",
  "editor.kmpErrBadPattern": "Поле pattern має бути рядком",
  "editor.kmpLen": "Довжини",
  "editor.kmpLenVal": "n={n}, m={m}",
  "editor.kmpTargetResult": "результат пошуку:",
  "editor.kmpEmptyPattern": "Порожній шаблон — вважається знайденим на 0.",
  "editor.kmpTooLong": "Шаблон довший за текст — входження неможливе (-1).",
  ...
  "play.kmpMonoNo": "ні",
  "play.kmpMonoYes": "так",
  "play.kmpStatResult": "результат:",
  "play.kmpStatLen": "текст/шаблон:",
  "play.kmpLcTitle": "Жива складність",
  "play.kmpLcActual": "Фактично:",
  ...
  "play.kmpTargetBadge": "шукаємо: {pattern}",
  ...
  "editor.bmMain": "Канонічний приклад",
  "editor.bmBigJumps": "Великі стрибки",
  "editor.bmWorst": "Найгірший (CAAAA)",
  "editor.bmMulti": "Кілька входжень",
  "editor.bmEditorTitle": "Текст і шаблон",
  "editor.bmLen": "Довжини",
  "editor.bmLenVal": "n={n}, m={m}",
  ...
  "editor.bmTargetResult": "результат пошуку:",
  "editor.bmTooLong": "Шаблон довший за текст — входження неможливе (-1).",
  ...
  "editor.bmErrBadText": "Поле text має бути рядком",
  "editor.bmErrBadPattern": "Поле pattern має бути рядком",
  ...
  "play.bmTargetBadge": "шукаємо: {pattern}",
  ...
  "play.bmStatResult": "результат:",
  "play.bmStatLen": "текст/шаблон:",
  "play.bmLcTitle": "Жива складність",
  "play.bmLcActual": "Фактично:",
  ...
  "editor.rkMain": "Канонічний приклад",
  "editor.rkCollision": "Колізія (for=jar)",
  "editor.rkMulti": "Кілька входжень",
  "editor.rkNotFoundPreset": "Не знайдено",
  "editor.rkEditorTitle": "Текст і шаблон",
  ...
  "editor.rkErrBadText": "Поле text має бути рядком",
  "editor.rkErrBadPattern": "Поле pattern має бути рядком",
  "editor.rkLen": "Довжини",
  "editor.rkLenVal": "n={n}, m={m}",
  "editor.rkPatternHash": "хеш шаблону (mod 101):",
  "editor.rkTargetResult": "результат пошуку:",
  "editor.rkEmptyPattern": "Порожній шаблон — вважається знайденим на 0.",
  "editor.rkTooLong": "Шаблон довший за текст — входження неможливе (-1).",
  ...
  "play.rkStatResult": "результат:",
  "play.rkLcTitle": "Жива складність",
  "play.rkLcActual": "Фактично:",
  ...
  "play.rkText": "текст",
  "play.rkPattern": "шаблон",
  "play.rkTargetBadge": "шукаємо: {pattern}",
...
const en: Record<MessageKey, string> = {
  ...
  "play.krLcTitle": "Live complexity",
  "play.krLcActual": "Actual:",
  ...
  "play.fwLcTitle": "Live complexity",
  "play.fwLcActual": "Actual:",
  ...
  "play.hkLcTitle": "Live complexity",
  "play.hkLcActual": "Actual:",
  "play.hkLcUnit": "dp cells",
  "play.hkLcPoly": "polynomial (wished)",
  "play.hkLcStates": "Held–Karp states",
  "play.hkLcVerdict": "Held–Karp: exponential — (n−1)·2^(n−1) DP states (polynomial would be ~n²). Best EXACT TSP (beats brute n! for large n), but still won't scale.",
  ...
  "play.knapLcTitle": "Live complexity",
  "play.knapLcActual": "Actual:",
  ...
  "play.primLcTitle": "Live complexity",
  "play.primLcActual": "Actual:",
  ...
  "play.isLcTitle": "Live complexity",
  "play.isLcActual": "Actual:",
  ...
  "play.ssLcTitle": "Live complexity",
  "play.ssLcActual": "Actual:",
  ...
  "play.msLcTitle": "Live complexity",
  "play.msLcActual": "Actual:",
  ...
  "play.shLcTitle": "Live complexity",
  "play.shLcActual": "Actual:",
  ...
  "play.rxLcTitle": "Live complexity",
  "play.rxLcActual": "Actual:",
  ...
  "play.lsLcTitle": "Live complexity",
  "play.lsLcActual": "Actual:",
  ...
  "play.issLcTitle": "Live complexity",
  "play.issLcActual": "Actual:",
  ...
  "play.ipLcTitle": "Live complexity",
  "play.ipLcActual": "Actual:",
  ...
  "play.nssLcTitle": "Live complexity",
  "play.nssLcActual": "Actual:",
  ...
  "editor.kmpMain": "Canonical example",
  "editor.kmpKonspect": "Notes example (“алг”)",
  "editor.kmpWorst": "Worst case (AAAA…)",
  "editor.kmpNotFoundPreset": "Not found",
  "editor.kmpEditorTitle": "Text and pattern",
  ...
  "editor.helpKmpKonspect": "the notes example: “алг” → position 4, lps = [0, 0, 0]",
  ...
  "editor.kmpErrBadText": "The text field must be a string",
  "editor.kmpErrBadPattern": "The pattern field must be a string",
  "editor.kmpLen": "Lengths",
  "editor.kmpLenVal": "n={n}, m={m}",
  "editor.kmpTargetResult": "search result:",
  "editor.kmpEmptyPattern": "Empty pattern — treated as found at 0.",
  "editor.kmpTooLong": "The pattern is longer than the text — no match possible (-1).",
  ...
  "play.kmpMonoNo": "no",
  "play.kmpMonoYes": "yes",
  "play.kmpStatResult": "result:",
  "play.kmpStatLen": "text/pattern:",
  "play.kmpLcTitle": "Live complexity",
  "play.kmpLcActual": "Actual:",
  ...
  "play.kmpTargetBadge": "searching: {pattern}",
  ...
  "editor.bmMain": "Canonical example",
  "editor.bmBigJumps": "Big jumps",
  "editor.bmWorst": "Worst (CAAAA)",
  "editor.bmMulti": "Several matches",
  "editor.bmEditorTitle": "Text and pattern",
  "editor.bmLen": "Lengths",
  "editor.bmLenVal": "n={n}, m={m}",
  ...
  "editor.bmTargetResult": "search result:",
  "editor.bmTooLong": "The pattern is longer than the text — no match possible (-1).",
  ...
  "editor.bmErrBadText": "The text field must be a string",
  "editor.bmErrBadPattern": "The pattern field must be a string",
  ...
  "play.bmTargetBadge": "searching: {pattern}",
  ...
  "play.bmStatResult": "result:",
  "play.bmStatLen": "text/pattern:",
  "play.bmLcTitle": "Live complexity",
  "play.bmLcActual": "Actual:",
  ...
  // — Rabin-Karp Search —
  "editor.rkMain": "Canonical example",
  "editor.rkCollision": "Collision (for=jar)",
  "editor.rkMulti": "Multiple matches",
  "editor.rkNotFoundPreset": "Not found",
  "editor.rkEditorTitle": "Text and pattern",
  ...
  "editor.rkErrBadText": "The text field must be a string",
  "editor.rkErrBadPattern": "The pattern field must be a string",
  "editor.rkLen": "Lengths",
  "editor.rkLenVal": "n={n}, m={m}",
  "editor.rkPatternHash": "pattern hash (mod 101):",
  "editor.rkTargetResult": "search result:",
  "editor.rkEmptyPattern": "Empty pattern — treated as found at 0.",
  "editor.rkTooLong": "The pattern is longer than the text — no match possible (-1).",
  ...
  "play.rkStatResult": "result:",
  "play.rkLcTitle": "Live complexity",
  "play.rkLcActual": "Actual:",
  ...
  "play.rkText": "text",
  "play.rkPattern": "pattern",
  "play.rkTargetBadge": "searching: {pattern}",
