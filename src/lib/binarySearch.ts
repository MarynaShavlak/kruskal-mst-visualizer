...
/**
 * Чи відсортований `arr` за зростанням? ПЕРЕДУМОВА коректності двійкового пошуку:
 * на невпорядкованих даних алгоритм може «відкинути» половину, де насправді лежить
 * шукане, і повернути -1 для наявного елемента.
 */
