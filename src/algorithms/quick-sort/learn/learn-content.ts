// Навчальний контент швидкого сортування: markdown перенесено з README
// Python-проєкту algo-quick-sort і збережено поруч як raw-рядки (трансформер
// scripts/transform-quick-sort-readme.mjs прибирає GitHub-«хром» і нумерує секції
