// Навчальний контент інтерполяційного пошуку: markdown перенесено з README
// Python-проєкту algo-interpolation-search і збережено поруч як raw-рядки (трансформер
// scripts/transform-interpolation-search-readme.mjs прибирає GitHub-«хром» і нумерує
