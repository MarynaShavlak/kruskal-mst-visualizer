// Навчальний контент пошуку Рабіна-Карпа: markdown перенесено з README Python-проєкту
// algo-rabin-karp-string-search і збережено поруч як raw-рядки (трансформер
// scripts/transform-rabin-karp-string-search-readme.mjs прибирає GitHub-«хром» і нумерує
