...
## 3. Intuition: why a hash instead of characters
...
## 4. The two phases of Rabin-Karp
...
## 5. Phase 1 — polynomial hash (string → number)
...
## 8. Complexity: `O(n+m)` on average vs `O(n·m)` in the worst case
...
## 10. Full step-by-step trace of the synopsis example
...
## 12. Four string algorithms: the summary table
