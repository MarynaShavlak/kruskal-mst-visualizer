...
import {
  LEARN_CONTENT,
  parseToc,
} from "@/algorithms/naive-string-search/learn/learn-content"
...
describe("parseToc (наївний пошук у рядках)", () => {
...
describe("figureForSrc: мапінг фігур на живі віджети", () => {
  ...
  it("відомі стеми (вкл. EN-префікс та walkthrough) дають живі віджети", () => {
    const known = [
      "docs/images/intuition_setup.png",
      "docs/images/intuition_slide.gif",
      "docs/images/intro_align_i0.png",
      "docs/images/intro_evolution.png",
      "docs/images/intro_grid.png",
      "docs/images/intro_match.png",
      "docs/images/wasted_work.png",
      "docs/images/not_found_grid.png",
      "docs/images/worst_case.png",
      "docs/images/complexity.png",
      "docs/images/all_matches.png",
      "docs/images/code_grid.png",
      "docs/images/en/search_canonical.gif",
      "docs/images/en/search_worst.gif",
      "docs/images/walkthrough/step_01.png",
      "docs/images/en/walkthrough/step_11.png",
    ]
