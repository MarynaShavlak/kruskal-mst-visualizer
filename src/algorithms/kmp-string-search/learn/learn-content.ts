...
// algo-knuth-morris-pratt-search і збережено поруч як raw-рядки (трансформер
// scripts/transform-kmp-string-search-readme.mjs прибирає GitHub-«хром» і нумерує секції
