...
Here is the base implementation — the one we walk through line by line (the fully documented version is in [`merge_sort/core.py`](merge_sort/core.py)):
...
We build this for the example array `[5, 3, 8, 4, 2]` (its line-by-line trace matches the walkthrough above); generated by [`examples/05_code_walkthrough.py`](examples/05_code_walkthrough.py). The tree trace for this array:
