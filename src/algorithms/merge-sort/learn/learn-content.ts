// Навчальний контент сортування злиттям: markdown перенесено з README
// Python-проєкту algo-merge-sort і збережено поруч як raw-рядки (трансформер
// scripts/transform-merge-sort-readme.mjs прибирає GitHub-«хром» і нумерує секції
