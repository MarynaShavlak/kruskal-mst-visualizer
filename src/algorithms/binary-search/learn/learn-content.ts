// Навчальний контент двійкового пошуку: markdown перенесено з README Python-проєкту
// algo-binary-search і збережено поруч як raw-рядки (трансформер
// scripts/transform-binary-search-readme.mjs прибирає GitHub-«хром» і нумерує секції
