...
import {
  LEARN_CONTENT,
  parseToc,
} from "@/algorithms/selection-sort/learn/learn-content"
...
describe("figureForSrc: мапінг фігур на живі віджети", () => {
  ...
  it("відомі стеми (вкл. EN-префікс і walkthrough) дають живі віджети, не запасну картку", () => {
    const known = [
      ...
      "docs/images/selection_idea.png",
      ...
      "docs/images/stability_compare.png",
    ]
