...
Here is the base implementation — the one we dissect line by line (the full version with docstrings is in [`selection_sort/core.py`](selection_sort/core.py)):
...
We build this for the example array `[5, 3, 8, 4, 2]` (its line-by-line trace matches the walkthrough above); generated by [`examples/05_code_walkthrough.py`](examples/05_code_walkthrough.py):
