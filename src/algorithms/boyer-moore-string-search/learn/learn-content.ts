// Навчальний контент пошуку Боєра-Мура: markdown перенесено з README Python-проєкту
// algo-boyer-moore-string-search і збережено поруч як raw-рядки (трансформер
// scripts/transform-boyer-moore-string-search-readme.mjs прибирає GitHub-«хром» і нумерує
