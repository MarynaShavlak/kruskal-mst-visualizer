// Навчальний контент порозрядного сортування: markdown перенесено з README
// Python-проєкту algo-radix-sort і збережено поруч як raw-рядки (трансформер
// scripts/transform-radix-sort-readme.mjs прибирає GitHub-«хром» і нумерує секції
