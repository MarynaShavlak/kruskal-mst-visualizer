// Навчальний контент сортування Шелла: markdown перенесено з README
// Python-проєкту algo-shell-sort і збережено поруч як raw-рядки (трансформер
// scripts/transform-shell-sort-readme.mjs прибирає GitHub-«хром» і нумерує секції
