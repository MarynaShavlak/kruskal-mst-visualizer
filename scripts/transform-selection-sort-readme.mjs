// Одноразовий трансформер: README Python-проєкту algo-selection-sort → навчальний
...
//
// Запуск:  node scripts/transform-selection-sort-readme.mjs [шлях-до-algo-selection-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-selection-sort"
const OUT = "src/algorithms/selection-sort/learn"
