...
//
// Запуск:  node scripts/transform-naive-string-search-readme.mjs [шлях-до-репо]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-rabin-karp-string-search"
const OUT = "src/algorithms/rabin-karp-string-search/learn"
