// Одноразовий трансформер: README Python-проєкту algo-bubble-sort → навчальний
...
//
// Запуск:  node scripts/transform-bubble-sort-readme.mjs [шлях-до-algo-bubble-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-bubble-sort"
const OUT = "src/algorithms/bubble-sort/learn"
