// Одноразовий трансформер: README Python-проєкту algo-interpolation-search →
...
//
// Запуск:  node scripts/transform-interpolation-search-readme.mjs [шлях-до-репо]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-interpolation-search"
const OUT = "src/algorithms/interpolation-search/learn"
