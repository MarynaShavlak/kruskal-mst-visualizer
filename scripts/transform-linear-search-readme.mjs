// Одноразовий трансформер: README Python-проєкту algo-linear-search → навчальний
...
//
// Запуск:  node scripts/transform-linear-search-readme.mjs [шлях-до-algo-linear-search]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-linear-search"
const OUT = "src/algorithms/linear-search/learn"
