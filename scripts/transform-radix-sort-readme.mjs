// Одноразовий трансформер: README Python-проєкту algo-radix-sort → навчальний
...
//
// Запуск:  node scripts/transform-radix-sort-readme.mjs [шлях-до-algo-radix-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-radix-sort"
const OUT = "src/algorithms/radix-sort/learn"
