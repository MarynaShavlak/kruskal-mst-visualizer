// Одноразовий трансформер: README Python-проєкту algo-merge-sort → навчальний
...
//
// Запуск:  node scripts/transform-quick-sort-readme.mjs [шлях-до-algo-merge-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-merge-sort"
const OUT = "src/algorithms/merge-sort/learn"
