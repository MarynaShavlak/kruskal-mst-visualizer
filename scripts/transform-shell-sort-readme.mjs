// Одноразовий трансформер: README Python-проєкту algo-shell-sort → навчальний
...
//
// Запуск:  node scripts/transform-quick-sort-readme.mjs [шлях-до-algo-shell-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-shell-sort"
const OUT = "src/algorithms/shell-sort/learn"
