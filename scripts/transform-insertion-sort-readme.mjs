// Одноразовий трансформер: README Python-проєкту algo-insertion-sort → навчальний
...
//
// Запуск:  node scripts/transform-insertion-sort-readme.mjs [шлях-до-algo-insertion-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-insertion-sort"
const OUT = "src/algorithms/insertion-sort/learn"
