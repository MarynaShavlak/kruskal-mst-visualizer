...
//
// Запуск:  node scripts/transform-kmp-string-search-readme.mjs [шлях-до-репо]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-knuth-morris-pratt-search"
const OUT = "src/algorithms/kmp-string-search/learn"
