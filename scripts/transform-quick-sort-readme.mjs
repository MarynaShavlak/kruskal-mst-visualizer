// Одноразовий трансформер: README Python-проєкту algo-quick-sort → навчальний
...
//
// Запуск:  node scripts/transform-quick-sort-readme.mjs [шлях-до-algo-quick-sort]
import { readFileSync, writeFileSync } from "node:fs"

const SRC = process.argv[2] ?? "/home/m-shavlak/WebstormProjects/algo-quick-sort"
const OUT = "src/algorithms/quick-sort/learn"
